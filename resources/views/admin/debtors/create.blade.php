                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="job_id" id="job_id" class="form-control" required>
                                ...
                                @foreach($jobs as $item)
                                    <option value="{{$item->id}} {{(old('job_id') ? 'selected' : '')}}">{{$item->description}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="source_of_debt" id="source_of_debt" class="form-control" cols="30" rows="5" placeholder="Descreva aqui o motivo do empréstimo" required>{{ old('source_of_debt') }}</textarea>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                            <label for="value">Valor do empréstimo *</label>
                            <input id="value" type="text" class="form-control mask-money" name="value" value="{{ old('value') }}" placeholder="Valor do empréstimo" required>
                        </div>
                    </div>
                </div>
            </div>
